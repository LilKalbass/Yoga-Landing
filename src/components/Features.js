...
const Features = () => {
  ...
  return (
      <section className = "bg-section min-h-[428px] pt-8 pb-9 lg:pb-40 mt-28 lg:mt-[132px]">
        <div className = "container mx-auto">
          ...
          <div className = "flex ">
            <div className = "flex-1">
              ...
              <h2 className = "h2 mb-3 lg:mb-2">The Better Way to <br/> Start Yoga</h2>
            </div>
          </div>
          <div>
            <p className = "max-w-[360px] mb-4 lg:mb-8">
