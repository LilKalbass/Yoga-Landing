      ...
      <section className = "section-sm lg:section-lg bg-green min-h-[520px]">
        <div className = "container mx-auto">
          <div className = "border-[8px] border-green-300 rounded-lg text-center pt-24 pb-12">
            <h4 className = "text-4xl lg:text-6xl text-white font-semibold lg:font-bold mb-3 lg:mb-4">Subscribe</h4>
            <p className = "text-lg lg:text-xl mb-6 lg:mb-12 text-green-200">Subscribe to our newsletter for further updates</p>
